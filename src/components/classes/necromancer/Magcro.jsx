...
import shards from "./skillsImages/Silver_Shards.png"

function Magcro() {
  return (
    <div className='display-class'>
    <h2>Magicka Necromancer</h2>
    
    <div className='intro'>
        <h3>Introduction</h3>
        <p>
            The Magicka Necromancer is a versatile class with good damage in both single-target and multi-target scenarios. It also brings a benefit to its group with its Ultimate, which applies Major Vulnerability.
        </p>
    </div>
        ...
        <div className='build-1'>
            ...
            <div className='skills'>
                ...
                <div className='bar-1'>
                    ...
                    <img src={shards} alt="silver shards"/>
