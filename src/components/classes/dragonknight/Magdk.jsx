...
function Magdk() {
  return (
    ...
    <h2>Magicka Dragonknight</h2>
    
    <div className='intro'>
        <h3>Introduction</h3>
        <p>
          The Magicka Dragonknight is a good class for multi-target fights. It excels, especially in solo content or 4-player dungeons. Its spell kit consists of many area-of-effect damages, favoring this aspect.
        </p>
    </div>
